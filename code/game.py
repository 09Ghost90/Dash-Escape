...
pygame.display.set_caption('Dash Escape')
...
def start():
    ...
    text_instructions = font.render('Pressione "W" para pular', True, (0, 0, 0))
    screen.blit(text_instructions, (width/2 - text_instructions.get_width()/2, height/2 - text_instructions.get_height()/2 - 50))
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN:
                ...
                elif event.key == K_ESCAPE and game_pause:
                    game_pause = False
                    died = False
        ...
        if not game_pause and not game_over:
            ...
            if attacking_flyers:
                ...
                attack_flyers_rect = pygame.Rect(player_x + player_width, player_y, 50, player_height)
                pygame.draw.rect(screen, (255, 0, 255), attack_flyers_rect)
